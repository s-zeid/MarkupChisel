...
export class MarkupChiselBaseView extends EditorView {
  ...
  static MARKDOWN_BASE_THEME = EditorView.baseTheme({
    ...
    "& .cm-line:has(> .tok-markup.tok-markCodeBlock:only-child)": { overflowY: "hidden", },
    "& .cm-line:has(> .tok-markup.tok-markCodeBlock:only-child) > .tok-markup.tok-markCodeBlock:only-child": { lineHeight: "0", verticalAlign: "-0.25em", },
